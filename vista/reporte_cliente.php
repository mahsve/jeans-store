...
<html lang="es">
    <head>
        <title>Reporte Lista de Clientes - My Jeans Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="wrapper2">
            ...
            <div class="content">
                <form action="../controlador/c_reporte_c.php" method="post" class="maestro" name="formulario">
                    <h2>Lista de clientes</h2>

                    <div class="radios">
                        <label>Ordenar por:</label>
                        <label for="cedula">Cedula</label>
                        <input type="radio" name="orden" value="1" id="cedula">
                        <i style="margin-left:25px;"></i>
                        <label for="nombre">Nombre</label>
                        <input type="radio" name="orden" value="2" id="nombre">
                    </div>
